...
public class CraftingRecipes {
	...
	public static void init() {
		...
		if (JJetpacks.rftools) {
			GameRegistry.addShapedRecipe(new ItemStack(ModItems.rftools, 1, 0), "tct", "zbz", "zez", 't', Items.GOLD_NUGGET, 'c', CoalGeneratorSetup.coalGeneratorBlock, 'z', Items.GLOWSTONE_DUST, 'b', ModItems.belt, 'e', Blocks.REDSTONE_BLOCK);
		...
		if (JJetpacks.actually) {
			GameRegistry.addShapedRecipe(new ItemStack(ModItems.actually, 1, 0), " a ", "bcb", "ded", 'a', new ItemStack(InitItems.itemMisc, 1, 6), 'b', InitItems.itemDrillUpgradeSpeed, 'c', ModItems.belt, 'd', new ItemStack(InitItems.itemMisc, 1, 7), 'e', InitItems.itemBattery);
		...
		if (JJetpacks.blood) {
			GameRegistry.addShapedRecipe(new ItemStack(ModItems.blood, 1, 0), "aba", "cdc", 'a', WayofTime.bloodmagic.registry.ModItems.arcaneAshes, 'b', ModItems.belt, 'c', Items.GOLD_INGOT, 'd', WayofTime.bloodmagic.registry.ModItems.sigilAir);
